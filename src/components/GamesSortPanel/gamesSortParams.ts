...
export const platformOptions: IGamesSortParams[] = [
    { value: '', label: "Все платформы" },
    { value: "pc", label: "PC" },
    { value: "browser", label: "Браузер" },
  ];
  
  export const categoryOptions: IGamesSortParams[] = [
  ...
  export const sortByOptions: IGamesSortParams[] = [
